        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentityStatement = table.Column<string>(type: "character varying(240)", maxLength: 240, nullable: false),
                    CueType = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    CueText = table.Column<string>(type: "character varying(240)", maxLength: 240, nullable: false),
                    RewardText = table.Column<string>(type: "character varying(240)", maxLength: 240, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastCompletedOn = table.Column<DateOnly>(type: "date", nullable: true),
                    LastCompletedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_habit_streaks", x => x.HabitId);
                    table.ForeignKey(
                        name: "FK_habit_streaks_habits_HabitId",
                        column: x => x.HabitId,
                        principalTable: "habits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_habit_logs_HabitId_OccurredAt",
                table: "habit_logs",
                columns: new[] { "HabitId", "OccurredAt" });

            migrationBuilder.CreateIndex(
                name: "IX_habits_UserId_IsArchived_CreatedAt",
                table: "habits",
